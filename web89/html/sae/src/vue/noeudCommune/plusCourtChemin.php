<form action="controleurfrontal.php?action=plusCourtChemin&controleur=noeudCommune" method="post">
    ...
    <fieldset>
        ...
        <p class="InputAddOn">
            ...
            <input class="InputAddOn-field" type="text" placeholder="Ex : Menton" name="nomCommuneDepart" id="nomCommuneDepart_id" required>
        </p>
        <p class="InputAddOn">
            <label class="InputAddOn-item" for="nomCommuneArrivee_id">Nom de la commune d'arrivé</label>
            <input class="InputAddOn-field" type="text" placeholder="Ex : Menton" name="nomCommuneArrivee" id="nomCommuneArrivee_id" required>
        </p>
